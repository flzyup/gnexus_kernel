...
#define OMAP4460_VDD_MPU_OPP25_UV		 800000
#define OMAP4460_VDD_MPU_OPP50_UV		 950000
#define OMAP4460_VDD_MPU_OPP100_UV		1200000
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1300000
...
#define OMAP4460_VDD_CORE_OPP25_UV		 928000
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	/* MPU OPP1 - OPP25 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 172800000, OMAP4460_VDD_MPU_OPP25_UV),
	/* MPU OPP1 - OPP50 */
	...
	/* MPU OPP4 - OPP-Nitro */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1382400000, OMAP4460_VDD_MPU_OPPNITRO_UV),
	...
	/* HSI OPP1 - OPP50 */
	OPP_INITIALIZER("hsi", "hsi_fck", "core", true, 115200000, OMAP4460_VDD_CORE_OPP50_UV),
	/* HSI OPP2 - OPP100 */
	OPP_INITIALIZER("hsi", "hsi_fck", "core", true, 115200000, OMAP4460_VDD_CORE_OPP100_UV),
	/* ABE OPP1 - OPP50 */
