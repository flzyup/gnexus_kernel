...
static int cx25821_dev_setup(struct cx25821_dev *dev)
{
	...
	strlcpy(cx25821_boards[UNKNOWN_BOARD].name,"unknown",sizeof(cx25821_boards[UNKNOWN_BOARD].name));
	strlcpy(cx25821_boards[CX25821_BOARD].name,"cx25821",sizeof(cx25821_boards[CX25821_BOARD].name));
