...
static int snd_card_saa7134_pcm(snd_card_saa7134_t *saa7134, int device)
{
	...
	pcm->info_flags = 0;
	strlcpy(pcm->name,"SAA7134 PCM",sizeof(pcm->name));
	return 0;
}
...
static int snd_card_saa7134_new_mixer(snd_card_saa7134_t * chip)
{
	...
	strlcpy(card->mixername,"SAA7134 Mixer",sizeof(card->mixername));
...
static int alsa_card_saa7134_create(struct saa7134_dev *dev, int devnum)
{
	...
	strlcpy(card->driver,"SAA7134",sizeof(card->driver));
	...
	strlcpy(card->shortname,"SAA7134",sizeof(card->shortname));
